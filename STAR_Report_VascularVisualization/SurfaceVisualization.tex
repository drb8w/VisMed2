...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{B-subdivision_refinement.jpg} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{Fold_of_vessel.jpg} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{Estimate_thickness.jpg} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.45\textwidth]{Remeshing_stage.jpg} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.33\textwidth]{Branching_ConvolutionSurfaces.jpg} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.33\textwidth]{Blending_ConvolutionSurfaces.jpg} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.33\textwidth]{ReconstructionFreeFormContours.jpg} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.33\textwidth]{IntersectingContours.jpg} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{BisectionMethod.jpg} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{Polygonization.jpg} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.4\textwidth]{TriangleQuality.jpg} \\
