...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.45\textwidth]{./Images/Remeshing_stage.png} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.33\textwidth]{./Images/Branching_ConvolutionSurfaces.png} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.33\textwidth]{./Images/Blending_ConvolutionSurfaces.png} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.33\textwidth]{./Images/ReconstructionFreeFormContours.png} \\
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.33\textwidth]{./Images/IntersectingContours.png} \\
