...
int main(int argc, char *argv[]) {
  if (argc < 3) {
    cout << "Usage: " << argv[0] << " <VTI file> <DAT file>" << endl;
    return EXIT_SUCCESS;
  }
  ...
  // -----------------------------------------------------------------------------------------
  //VoxelDataWriter::WriteDatFile(imageData, "c:/temp/MED.dat", false);
  //VoxelDataWriter::WriteDatFile(reader, "c:/temp/MED.dat", false);
  unsigned short resolution_max = 512;
  VoxelDataWriter::WriteDatFile(reader, argv[2], false, resolution_max);
  //double *scaleFactors = new double[3];
  //scaleFactors[0] = 1;
  //scaleFactors[1] = 1; 
  //scaleFactors[2] = 512.0 / 76.0;
  //VoxelDataWriter::WriteDatFile(reader, scaleFactors, "c:/temp/MED.dat", false);
  // -----------------------------------------------------------------------------------------
